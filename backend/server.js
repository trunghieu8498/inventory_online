...
app.post('/api/warehouse/get/all', warehouse.getWarehouseAsAdmin)
...
app.post('/api/type/get/:id', type.getTypeByWarehouse_id)
app.post('/api/type/get/all', type.getTypesAsAdmin)
...
app.post('/api/goods/get/all', goods.getGoodsAsAdmin)
...
app.post('/api/receivednote/get/all', receivednote.getReceivedNotesAsAdmin)
...
app.get('/api/receivednotedetail/get/:id', receivednotedetail.getReceivedNoteDetailsByReceivedNoteId)
