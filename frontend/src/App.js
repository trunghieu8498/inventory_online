          ...
          <div style={{ margin: "2rem" }}>
            <Switch>
              ...
              <Route
                exact
                path="/warehouse"
                component={() => Page(WarehouseTable)}
              />
              <Route
                exact
                path="/warehouse/add"
                component={() => Page(AddWarehouseForm)}
              />
              ...
              <Route
                exact
                path="/type/add"
                component={() => Page(AddTypeForm)}
              />
              <Route
                exact
                path="/deliverynote"
                component={() => Page(DeliveryNoteTable)}
              />
              <Route
                exact
                path="/receivednote"
                component={() => Page(ReceivedNoteTable)}
              />
              <Route
                exact
                path="/goods/add"
                component={() => Page(AddGoodsForm)}
              />
              <Route
                exact
                path="/receivednote/add"
                component={() => Page(AddReceivedNoteForm)}
              />
              <Route
                exact
